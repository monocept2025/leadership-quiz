...
function Results() {
  ...
  const data = [
    { name: 'Amiable', value: categories.amiable, percentage: (categories.amiable / totalAnswers) * 100 },
    { name: 'Driver', value: categories.driver, percentage: (categories.driver / totalAnswers) * 100 },
    { name: 'Analytical', value: categories.analytical, percentage: (categories.analytical / totalAnswers) * 100 },
    { name: 'Expressive', value: categories.expressive, percentage: (categories.expressive / totalAnswers) * 100 },
  ];
